...
navHumburger.addEventListener("click",function (){ 
    ...
    headerMobile.classList.toggle("apparent");
...
document.addEventListener('scroll', ()=>{
    if (hero.getBoundingClientRect().height-headerdesktop.getBoundingClientRect().height<=window.pageYOffset) {

        headerdesktop.classList.add('header--top')
    }else{
        headerdesktop.classList.remove('header--top')
    }
